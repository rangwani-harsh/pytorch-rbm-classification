...
rbm = ClassificationRBM(args.visible_units, args.hidden_units, args.cd_k, learning_rate = args.lr, use_cuda=CUDA)


loss_list, best_model = train_rbm(rbm, train_loader, validation_loader, 'discriminative', GENERATIVE_FACTOR)


######### TESTING RBM ##########

test_rbm_model(best_model, test_loader)